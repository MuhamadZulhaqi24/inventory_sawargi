    ...
    <div class="p-6">
        ...
        <div class="mb-6 space-y-1.5 text-center sm:text-left border-b border-gray-200 pb-4">
            <h3 class="text-lg font-semibold leading-none tracking-tight text-foreground">
                {{ $isEditing ? __('messages.edit_transaction') : __('messages.add_transaction') }}
            </h3>
            <p class="text-sm text-muted-foreground">
                {{ $isEditing ? __('messages.update_transaction_subtitle') : __('messages.record_new_transaction_subtitle') }}
            </p>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <x-form-input
                    ...
                    :label="__('messages.external_reference')"
            ...
            <!-- Type -->
            <div class="space-y-3">
                <x-input-label for="type" :value="__('messages.type')" :required="true" />
            ...
            <!-- Amount -->
            <div class="space-y-2">
                <x-input-label for="amount" :value="__('messages.amount') . ' (Rp)'" :required="true" />
                <x-currency-input
                    id="amount"
            ...
            <div class="space-y-2">
                ...
                <textarea
                    ...
                    :placeholder="__('messages.optional_details')"
                ></textarea>
            ...
            <div class="mt-6 flex justify-end gap-3 border-t border-gray-200 pt-4">
                ...
                <x-primary-button type="submit" wire:loading.attr="disabled">
                    ...
                    {{ $isEditing ? __('messages.save_changes') : __('messages.save_transaction') }}
                </x-primary-button>
            </div>
        </form>
    </div>
