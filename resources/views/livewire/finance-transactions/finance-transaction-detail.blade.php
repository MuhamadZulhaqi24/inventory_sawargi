        ...
        <div class="p-6">
            ...
            <div class="mb-6 space-y-1.5 text-center sm:text-left border-b border-gray-200 pb-4">
                ...
                <p class="text-sm text-muted-foreground">
                    {{ __('messages.detailed_info_regarding_transaction') }} #{{ $transaction->id }}.
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.code') }}</label>
                        <p class="text-sm text-foreground font-medium font-mono">{{ $transaction->code }}</p>
                    </div>

                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.date') }}</label>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.category') }}</label>
                        <p class="text-sm text-foreground font-medium">{{ $transaction->category->name }}</p>
                    </div>

                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.amount') }}</label>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.type') }}</label>
                        <div>
                    ...
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.external_reference') }}</label>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.created_by') }}</label>
                ...
                <div class="space-y-1">
                    <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('messages.description') }}</label>
