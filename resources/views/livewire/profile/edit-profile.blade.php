    ...
    <form wire:submit="updateProfile" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-card p-6 rounded-lg border border-border">
            <div class="md:col-span-2">
                <h3 class="text-lg font-medium text-foreground">{{ __('messages.profile_information') }}</h3>
                <p class="mt-1 text-sm text-muted-foreground">{{ __('messages.update_profile_subtitle') }}</p>
            </div>

            <div class="space-y-2">
                <x-input-label for="name" :value="__('messages.name')" required />
                <x-text-input
                    wire:model="name"
                    id="name"
                    name="name"
            ...
            <div class="space-y-2">
                <x-input-label for="username" :value="__('messages.username')" required />
                <x-text-input
                    wire:model="username"
                    id="username"
                    name="username"
            ...
            <div class="space-y-2 md:col-span-2">
                <x-input-label for="email" :value="__('messages.email')" required />
                <x-text-input
                    wire:model="email"
                    id="email"
                    name="email"
