        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div>
                ...
                <p class="mt-6 text-lg text-muted-foreground leading-relaxed">
                    {{ \App\Models\Setting::get('store_name') }} {{ __('telah menjadi mitra terpercaya bagi para pembangun dan pemilik rumah selama lebih dari dua dekade. Kami memulai perjalanan kami dari sebuah toko kecil di Pamijahan dengan visi sederhana: menyediakan bahan bangunan berkualitas tinggi dengan harga yang jujur.') }}
                </p>
                ...
                <div class="mt-10 grid grid-cols-2 gap-8">
                    <div>
                        <div class="text-4xl font-black text-primary">25+</div>
                        <div class="mt-1 text-sm font-semibold text-muted-foreground uppercase tracking-wider">{{ __('Tahun Pengalaman') }}</div>
                    </div>
                    <div>
                        <div class="text-4xl font-black text-primary">10k+</div>
                        <div class="mt-1 text-sm font-semibold text-muted-foreground uppercase tracking-wider">{{ __('Proyek Selesai') }}</div>
                    </div>
                </div>
            </div>
            <div class="mt-12 lg:mt-0">
                <div class="aspect-video rounded-3xl overflow-hidden bg-muted flex items-center justify-center relative shadow-2xl">
                    <x-heroicon-o-users class="w-32 h-32 text-primary/20" />
