        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => __('messages.delete_user_confirmation', ['name' => $row->name]),
                ])
                ->tooltip(__('messages.delete_user'))
        ];
    }
    ...
    public function delete($userId, \App\Services\UserService $service): void
    {
        ...
        if ($user) {
            try {
                ...
                $this->dispatch('toast', message: __('messages.user_deleted'), type: 'success');
            } catch (\Exception $e) {
