...
final class CustomerTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.date'), 'created_at_formatted', 'created_at')
                ->sortable()
    ...
    public function actions(Customer $row): array
    {
        return [
            Button::add('view')
                ...
                ->tooltip(__('messages.view_customer')),
            ...
            Button::add('edit')
                ...
                ->tooltip(__('messages.edit_customer')),
    ...
    public function delete($rowId, CustomerService $customerService): void
    {
        ...
        if ($customer) {
            try {
                ...
                $this->dispatch('toast', message: __('messages.customer_deleted'), type: 'success');
            } catch (\Exception $e) {
