...
final class UnitTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.symbol'), 'symbol')
                ->sortable()
                ->searchable(),
    ...
    public function delete($rowId, UnitService $service): void
    {
        ...
        if ($unit) {
            try {
                ...
                $this->dispatch('toast', message: __('messages.unit_deleted'), type: 'success');
            } catch (\Exception $e) {
