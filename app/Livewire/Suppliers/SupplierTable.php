...
final class SupplierTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.supplier_name'), 'name')
                ->sortable()
                ->searchable(),

            Column::make(__('messages.contact_person'), 'contact_person')
                ->sortable()
                ->searchable(),
            ...
            // Exports
            Column::make(__('messages.address'), 'address')
                ->hidden()
                ->visibleInExport(true),
    ...
    public function actions(Supplier $row): array
    {
        return [
            Button::add('view')
                ...
                ->tooltip(__('messages.view_supplier')),
            ...
            Button::add('edit')
                ...
                ->tooltip(__('messages.edit_supplier')),
    ...
    public function delete($rowId, SupplierService $supplierService): void
    {
        ...
        if ($supplier) {
            try {
                ...
                $this->dispatch('toast', message: __('messages.supplier_deleted'), type: 'success');
            } catch (\Exception $e) {
